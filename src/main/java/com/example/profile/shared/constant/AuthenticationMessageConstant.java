...
public final class AuthenticationMessageConstant {
    ...
    public static final String REGISTER_MESSAGE = "Đăng ký tài khoản thành công!";
    public static final String LOGIN_SUCCESS = "Đăng nhập thành công!";
    public static final String USER_NOT_FOUND = "Tên đăng nhập hoặc mật khẩu không chính xác!";
    public static final String USERNAME_ALREADY_EXISTS = "username đã tồn tại.";
    public static final String USER_DISABLE = "Tài khoản đã bị vô hiệu hóa";
    public static final String USER_LOCKED = "Tài khoản đang bị khóa";
    public static final String USER_NON_EXPIRED = "Tài khoản đã hết hạn";
}
